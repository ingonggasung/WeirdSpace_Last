...
public class Kit_Tele_No : MonoBehaviour
{
    int stageIndex;
    ...
    IEnumerator FadeAndTeleport(Collider2D other)
    {
        ...
        SceneManager.LoadScene("kitchen wrong");
        PlayerController playerController = other.GetComponent<PlayerController>();
        if (playerController != null)
        {
        ...
        if (gameManeger != null)
        {
            ...
            InterstitialAdExample interstitialAdExample = other.GetComponent<InterstitialAdExample>();
